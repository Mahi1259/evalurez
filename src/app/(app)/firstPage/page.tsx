              ...
              <div className="lg:col-span-7 space-y-8">
                <h1 className="text-4xl md:text-4xl lg:text-6xl font-bold tracking-tight">
                  ...
                  <span className="relative">
                    <span className="text-purple-800 dark:text-purple-400">Evalurez</span>
                    <span className="absolute bottom-0 left-0 w-full h-1 bg-purple-800 dark:bg-purple-400"></span>
                  </span>
                </h1>
                <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 leading-relaxed">
                  Struggling to get your resume noticed? Evalurez is an AI-powered platform that analyzes your resume,
                  scores it, and provides actionable insights to help you stand out. With its built-in Resume Builder,
                  you can create a professional, optimized resume with complete control over every detail. Tailor your
                  resume for recruiters, increase your chances of landing your dream job, and take control of your
                  career with Evalurez. Get started today!
                </p>
              </div>
